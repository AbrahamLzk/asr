...
audio_format = ''   # 音频支持格式，如pcm8k16bit，详见api文档
property = ''       # 属性字符串，language_sampleRate_domain, 如chinese_8k_common, 采样率要和音频一致。详见api文档
...
def rasr_example():
    ...
    # websocket暂时不支持使用代理
    rasr_client = RasrClient(user_name, password, domain_name, region, project_id, my_callback, config)
